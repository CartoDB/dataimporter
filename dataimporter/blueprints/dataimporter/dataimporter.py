...
class ImportForm(FlaskForm):
    ...
    x_column = StringField("X column", description="Column that contains the x coordinate", default="")
    y_column = StringField("Y column", description="Column that contains the y coordinate", default="")
    srid = IntegerField("SRID", default=4326)
    chunk_size = IntegerField("Chunk size", validators=[DataRequired()], description="Number of items to be grouped on a single INSERT or DELETE request", default=100)
